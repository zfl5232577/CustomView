...
public class SourceLinearLayoutManager extends RecyclerView.LayoutManager implements
     ...
     */
    public SourceLinearLayoutManager(Context context) {
     ...
     */
    public SourceLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
     ...
     */
    public SourceLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                               int defStyleRes) {
    ...
    int scrollBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.e(TAG, "scrollBy: "+getChildCount() );
    ...
    static class LayoutState {
        ...
        View next(RecyclerView.Recycler recycler) {
            if (mScrapList != null) {
                Log.e(TAG, "next: mScrapList != null" );
