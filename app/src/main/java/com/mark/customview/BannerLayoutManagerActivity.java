...
import com.mark.customview.RecyclerView.BannerLayoutManager;
import com.mark.customview.RecyclerView.CardLayoutManager;

import java.util.ArrayList;
import java.util.List;

public class BannerLayoutManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final BannerLayoutManager layoutManager = new BannerLayoutManager(recyclerView,1);
        layoutManager.setSurplusWidth(45);
